...
# ============================================================= =
#
# Figure 3B - differential saddle plots, one per mutant.
#
# Bins are ranked by the wild-type PC1 and grouped into 50 quantile groups. Each
...
# quantified in Figure 3C (see figure_3C.R). The bars on the two margins give
# the median eigenvector value of each quantile group.
#
# Supplementary Fig. S5B is the same analysis ranked by PC2: see figure_S5B.R.
# ============================================================= =
