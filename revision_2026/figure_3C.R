...
# ============================================================= =
#
# Figure 3C - quantification of the differential saddle plots of Figure 3B.
#
# For every genotype, bins are ranked by the wild-type PC1 and grouped into 50
...
#
# Supplementary Fig. S5C is the same analysis ranked by PC2: see figure_S5C.R.
# ============================================================= =
